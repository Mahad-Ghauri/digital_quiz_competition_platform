...
class BlogDetailPage extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      appBar: AppBar(
        title: Text(
          languageProvider.translate('blogDetails'),
          style: TextStyle(
                ...
                children: [
                  ...
                  Row(
                    children: [
                      ...
                      Text(
                        "${languageProvider.translate('author')}: ${blog.author}",
                        style: TextStyle(
                          fontFamily: GoogleFonts.poppins().fontFamily,
                      ...
                      const SizedBox(width: 4.0),
                      Text(
                        "${languageProvider.translate('date')}: ${blog.date}",
                        style: TextStyle(
                          fontFamily: GoogleFonts.poppins().fontFamily,
                          color: Colors.grey[700],
                          fontSize: 16,
                  ...
                  Container(
                    ...
                    child: Center(
                      child: Text(
                        languageProvider
                            .translate('relatedArticlesPlaceholder'),
                        style: TextStyle(
                          fontFamily: GoogleFonts.poppins().fontFamily,
